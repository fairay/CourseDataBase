...
\begin{lstlisting}[caption = {Релизация функций для таблицы DriverDuty}, label=lst:driver_duty_f]
...
\begin{lstlisting}[caption = {Релизация функций для таблицы GuardDuty}, label=lst:guard_duty_f]
