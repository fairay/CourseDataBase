...
from .pers_rep import PersonRepository, PWPersonRep
from .acc_rep import AccountsRepository, PWAccountsRep
from .truck_rep import TrucksRepository, PWTrucksRep
